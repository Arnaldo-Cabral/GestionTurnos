...
exports.create = async (req, res) => {
  ...
  try {
    ...
    // 3. BUSCAR AL RECEPCIONISTA REAL (Por usuario_id)
    let recepcionistaReal = await Recepcionista.findOne({ where: { usuario_id: recepcionista_id } });

    // Si no lo encontramos por usuario_id, probamos si nos enviaron el ID directo
...
/* ======== CON ESTO PUEDO CAMBIAR EL ESTADO DEL TURNO ======== */
